...
<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <select class="form-control" onchange="selectSchool(this.value)">
        <option value="">Select School</option>
        <option value="school10">10.Kings Way Primary School</option>
        <option value="school9">9.All Saints' Primary School</option>
        <option value="school8">8.New Hope Primary School</option>
        <option value="school6">6.Kings Primary School</option>
        <option value="school5">5.Glories Primary School</option>
        <option value="school4">4.St.Jude Primary School</option>
        <option value="school3">3.Buyenga Primary School</option>
        <option value="school2">2.Namugongo Primary School</option>
        <option value="school1">1.St.Elizabeth PrimarySchool</option>
    </select>
</div>
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">REGISTERED PUPILS</p>
                                <h4 class="mb-0">20</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">WINNERS</p>
                                <h4 class="mb-0">2</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="card">
                        <div class="card-header p-3 pt-2">
                            ...
                            <div class="text-end pt-1">
                                <p class="text-sm mb-0 text-capitalize">MOST CORRECTLY ATTEMPTED QUESTIONS</p>
                                <h4 class="mb-0">40</h4>
                            </div>
                        </div>
                        <hr class="dark horizontal my-0">
